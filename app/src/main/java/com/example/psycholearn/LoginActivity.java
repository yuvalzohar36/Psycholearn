...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (user != null){
            finish();
            startActivity(new Intent(LoginActivity.this, HomePageActivity.class)); /// build applicactivity
        }
        Login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if ((!Username.getText().toString().equals("")) && !Password.getText().toString().equals("")){
                    ...
                    Toast.makeText(LoginActivity.this, "פרטים חסרים", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        firebaseAuth.signInWithEmailAndPassword(userName, UserPassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(LoginActivity.this, "התחברות הושלמה", Toast.LENGTH_SHORT).show();
